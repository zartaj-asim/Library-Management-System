...
//				}
				...
				CBook getBook(int ID){												//Dereferencing this pointer to return whole book.
		...
		public:
			...
			void setIssuedBook(bookNode *iB, int bookID){
				...
				if(counter < 5){														//To make sure user issues not more than 5 books.
					...
					this->issuedBooks[counter] = iB->object.getBook(bookID);			//To get issued book from the list we desire to issue.
